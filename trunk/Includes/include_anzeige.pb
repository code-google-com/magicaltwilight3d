...
; --------------------------------------------------------------------
  ...
  EndProcedure
   ...
   Procedure anz_updateinput() ; mouse and keyboard management
      ...
      Protected spi_current_AnimNR.i , *waffe_item.ITEM , *waffe.item_waffe , *itemID.ITEM , anz_key_tipped_e
   ...
   ; ----------------------------------------------------------------------------------------
    ...
    ; sonstige ingame controlls
      ...
      If GetAsyncKeyState_(#VK_E) ; Zum Benutzen bzw. öffnen, Item aufnehmen usw.
         If anz_key_tipped_e = 0
            anz_key_tipped_e = 1
