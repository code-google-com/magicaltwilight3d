...
Procedure wes_AddWesen ( name.s, x.f , y.f , z.f , Team.s , maxleben.i , speed.f , pfad.s , texture1.s , texture2.s , MaterialType.i , Isdirectload.i = 0 , SpielerID.i = 0 , art.i =#wes_art_schwert , action.i = #wes_action_stand ,  AnimNR.i = 0 , animlist.s = #ani_Animlist_Standard) ; wobei team: siehe #team_wesen_bundnis_...)
  ...
  *newwesen = AddElement(wes_wesen())
  ...
  If *newwesen 
     ...
     *newwesen\anz_Mesh_ID    = anz_addmesh              ( pfad , x , y , z , texture1 , MaterialType , texture2 , Isdirectload , #anz_col_box , #anz_ColType_movable )
...
Procedure wes_KillWesen( *WesenID.wes_wesen)
   ...
   Protected x.f , y.f , z.f , *item.ITEM
      ...
      *WesenID\action    = #wes_action_die 
      IrrGetNodePosition ( anz_getObject3DIrrNode ( anz_getobject3dByAnzID ( *WesenID\anz_Mesh_ID )), @x , @y , @z )
...
Procedure wes_RemoveWesen(*WesenID.wes_wesen)
   ...
   If *WesenID 
      anz_delete_object3d  ( anz_getobject3dByAnzID ( *WesenID\anz_Mesh_ID))
...
Procedure wes_MoveWesenToWaypoint( *WesenID.wes_wesen , *waypointid.WAYPOINT ) ; bewegt ein Wesen direkt (irrlicht based) ; prüft vorher die bodenhöhe
   Protected  x.f , y.f , z.f , *startvector.IRR_VECTOR , *endvector.IRR_VECTOR , *Rot.IRR_VECTOR , *Collisionvector.IRR_VECTOR 
...
Procedure wes_MoveWesenToPosition ( *WesenID.wes_wesen , x.f , y.f , z.f)
   Protected   startvector.IRR_VECTOR , endvector.IRR_VECTOR , Rot.IRR_VECTOR , Collisionvector.IRR_VECTOR 
...
Procedure wes_Examine_Reset( IrrZentrumNode.i  , only_they_in_view.b = 1 , max_distance.f = #meter * 10  ) ; Überprüft, ob Nodes in der Nähe sind (bzw. alle nodes überhaupt z.b. zum material setzen)
   Protected x1.f , y1.f , z1.f ,  *p_obj.anz_Object3d , ObjectArt.w , irr_obj.i , rasterx.i , rastery.i , rasterz.i , *anz_mesh.anz_mesh    ; wenn Onlywess1_OnlyWesen2 = 1, dann nur wess suchen, wenn =2, dann nur wesen.
      ...
      IrrGetNodePosition( IrrZentrumNode , @x1 , @y1 , @z1)   ; prüft die Position des IrrNodes , um das herum gesucht wird.
      ...
      While wes_examine_Next() ; alle Wesen überprüfen
         ...
         *newwesen.wes_wesen = wes_Examine_get_WesenID()
         ...
         If team_IsFreund( *newwesen\Team , *WesenID\Team ) And Not ( team_IsFreund( *newwesen\Team , *gegnerid\Team )) ; wenn freunde in nähe, die nicht mit gegner auch verbündet sind.
            If Not ( *newwesen\action = #wes_action_die Or *newwesen\action = #wes_action_defend Or *newwesen\action = #wes_action_attack Or *newwesen\action = #wes_action_moveAttack ); wenn freund grad nichts besseres zu tun hat
...
Procedure wes_FlieFromGegner(*WesenID.wes_wesen , *gegnerid.wes_wesen)
   Protected x.f , y.f , z.f , vect.IRR_VECTOR , gx.f , gy.f , gz.f 
   
      IrrGetNodePosition  ( anz_getObject3DIrrNode( anz_getobject3dByAnzID( *WesenID\anz_Mesh_ID ))  , @x  , @y  , @z)
      IrrGetNodePosition  ( anz_getObject3DIrrNode( anz_getobject3dByAnzID( *gegnerid\anz_Mesh_ID )) , @gx , @gy , @gz)
...
Procedure wes_UpdateWesen(*WesenID.wes_wesen) ; regelt Grundverhalten (instinkte) und komplette Animation der Wesen. + bewegen, kämpfen, etc
   Protected *spielerwesen.wes_wesen , *newwesen.wes_wesen , NewList wes_friendlist.i () , wes_friend_amount.i , x.f , y.f , z.f , x1.f , y1.f , z1.f , *startvector.IRR_VECTOR , *endvector.IRR_VECTOR , *Rot.IRR_VECTOR , *Collisionvector.IRR_VECTOR  , *GegnerWesenID.wes_wesen , Gegnerdist.f
   ...
   Select *WesenID \ action 
      ...
      Case #wes_action_die
         ...
         ;{ Wesen löschen, wenn TOT, und deleten, wenn sterbeanimation = aus
                  ...
                  Else ; ansonsten, wenn gerade nicht geladen wird ( Schießen lässt sich ja nicht beenden.
                     ani_setaniminterruptable  ( *WesenID\anz_Mesh_ID   , 0)
      ...
      Case #wes_action_defend  
         ...
         If item_waffe_getReichweite  ( *WesenID\Waffe_Item_ID ) >= wes_getdistance( *WesenID , *WesenID\gegnerid ) ; wenn gegner schon in Reichweite
            ...
            ; erstmal Hindrehen zum Feind
            IrrFaceTargetNode( wes_getNodeID ( *WesenID ) , wes_getNodeID( *WesenID\gegnerid  ))
...
; FoldLines=0040004D004F00570059006D006F008C008E009200940098009A009E00A000AC
; FoldLines=00AE00B200B400B800BA00BE00C000CA00CC00CE00D000D500D700DD00DF00E7
; FoldLines=00E900ED00EF00F300F500F700F900FB00FD00FF0101010B010D011101130139
; FoldLines=013B0168016A016D016F01710173017501BD01BF01C101C301C501C701C901CB
; FoldLines=01CD01D201D401D901DB01E001E201E701E901EE01F001F501F701FC01FE0203
; FoldLines=0205020A020E0215022D0239023B0251025302600262026902B502C402C802D6
; FoldLines=02DA02EA031B032A032E034703510397035D000003700000039B03BB03BF03C6
; FoldLines=03CA03D103D503DD03E103E803EE03F403F60401
; Build=0
; FirstLine=281
; CursorPosition=664
