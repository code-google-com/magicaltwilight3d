...
; -----------------------------------------------------------------------------------------------------------------
   ...
   Procedure kam_SchiesPfeil ( *WesenID.wes_wesen , *ZielwesenID.wes_wesen) ; schießt einen Pfeil in richtung gegner ab. (kann danebenfliegen)
      ...
      Protected *waffe.item_waffe , *item.ITEM , x.f , y.f , z.f , x1.f , y1.f , z1.f, vect.IRR_VECTOR , distance.f , rotx.f ,roty.f , rotz.f 
         ...
         *waffe                = *item             \ WaffenID 
         ...
         IrrGetNodeRotation    ( wes_getNodeID( *WesenID ) , @rotx   , @roty , @rotz ) ; roty für Pfeilroty.
   ...
   EndProcedure 
    ...
    Procedure kam_Focuswesen_Reset ()  ; überprüft das Fokus-Item
        ...
        wes_Examine_Reset(spi_GetPlayerNode( spi_getcurrentplayer())) ; alle umliegenden wesens überprüfen
            ...
            While wes_examine_Next()
                ...
                ; --------------------- PAUSE ------------------------------
                ; -----------------------------------------------------------
                ; zu fertig zumweitermachen.. aber an und für sich isses hier nicht schwer.
                ...
                If math_distance3d         ( px,py,pz,pix,piy,piz) < #meter*1.7 ; wenn der abstand von wesen zu spieler kleiner 1.7 m ist .. ;math_square_distance2d  ( 0 , pz , 0 , piz )     < #meter * 2 And math_square_distance2d( 0 , pz , 0 , piz) > - 1.3* #meter  ; wesen darf max. 2m über und 1m unterhalb von spieler sein.
   ...
   Procedure kam_SchiesSchwert  ( *WesenID.wes_wesen , *ZielwesenID.wes_wesen ) ; schlägt mit dem Schwert einmal zu.(Animation wird hier niht geretelt!!
      ; SOUND Nicht vergessen!!
